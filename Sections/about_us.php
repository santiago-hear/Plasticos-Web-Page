<h1 class="display-3 text-center">¿Quienes Somos?</h1>
<section class="display-5 text-center py-3">
    <p>
...
<h3 class="display-5 text-center py-3">Misión</h3>
<section>
    <p>
        Somos una empresa fundada el 10 de Agosto de 2020
        por Carlos Mario, idea que nació a raíz de la 
...
<h3 class="display-5 text-center py-3">Visión</h3>
<section>
    <p>
        Somos una empresa fundada el 10 de Agosto de 2020
        por Carlos Mario, idea que nació a raíz de la 
